...
class _AppLogoState extends State<AppLogo> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _h3LetterCount = StepTween(begin: 0, end: h3.length).animate(
      CurvedAnimation(
    ...
    _h1LetterCount = StepTween(begin: 0, end: h1.length).animate(
      CurvedAnimation(
    ...
    _s1LetterCount = StepTween(begin: 0, end: s1.length).animate(
      CurvedAnimation(
    ...
    // Start animations (without looping)
